...
export async function contratarPlanService(data) {
  try {
    const response = await api.post('/inscripciones/contratar', data);
...
export async function pagarDeudaService(id_inscripcion, monto_pago) {
  try {
    const response = await api.post(`/inscripciones/${id_inscripcion}/pagar`, { monto_pago });
    return response.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export async function obtenerDeudasPendientesService(alumno_id) {
  try {
    const response = await api.get(`/inscripciones/alumno/${alumno_id}/deudas`);
    return response.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export async function obtenerInscripcionesPorAlumnoService(alumno_id) {
  try {
    const response = await api.get(`/inscripciones/alumno/${alumno_id}`);
    return response.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export async function obtenerInscripcionPorIdService(id_inscripcion) {
  try {
    const response = await api.get(`/inscripciones/${id_inscripcion}`);
    return response.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export async function cancelarInscripcionService(id_inscripcion) {
  try {
    const response = await api.put(`/inscripciones/${id_inscripcion}/cancelar`);
    return response.data;
  } catch (error) {
    throw error.response?.data || error;
  }
